...
while True:
	...
	if x.upper() == 'C':
		...
		while nhaphanghoa.upper() == 'Y':
			...
			tenmathang=input("nhap ten hang hoa: ")
			hanghoa["ten"] = tenmathang
			for 
		...
		with open ('danhmuc/hoadon/HD'+ sohoadon+'.json',"w")as infile :
				json.dump(hoadon,infile)	
	...
	if x.upper() == 'R':
		...
		#for stt in hoadon[danhsachhanghoa]['hanghoa']
			#stt=str
			#stt=stt+' '
		#for ten in hoadon[danhsachhanghoa]['hanghoa']
			#ten=str
			#ten=ten + ' '
		#for soluong in hoadon[danhsachhanghoa]['hanghoa']
			#soluong=str
			#soluong=soluong+' '
		#for ten in hoadon[danhsachhanghoa]['hanghoa']
			#dongia=str
		...
		#for ten in hoadon[danhsachhanghoa]['hanghoa']
			#thanhtien=str
			#thanhtien=thanhtien+' '
		#for tongten in danhsachhoadon['hoadon']
			#tongten=str 
			#tongten=tongtien+' '
		#hoadon["tongtentruoctheu"]
		#hoadon["thue"]
		timthay = False
		while timthay is False:
			...
			for hoadon in danhsachhoadon:
				if hoadon["sohoadon"] == sohoadon_canxem:
					timthay = True
					data=None
					with open  ('danhmuc/hoadon/HD'+sohoadon+'.json',"r")as outfile:
